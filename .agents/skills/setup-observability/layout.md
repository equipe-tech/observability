...
| `observability/platform-rules.json`   | user-preserved platform-rule extension         |
| `observability/network-policy.json`   | user-preserved network-policy extension        |
...
| `observability/source-maps.ts`        | skill-owned Sentry source-map execution        |
| `observability/sentry.transport.ts`   | user-preserved Sentry event/read-back binding  |
| `observability/sentry-canary.ts`      | skill-owned identity-bound Sentry verification |
